...
$string['aireasoningmodel'] = 'The model returned only its reasoning and no hint. This looks like a "thinking" model; turn off its reasoning mode or choose a different model.';
...
$string['fallback_structural'] = 'A term that involves the variable is not right. Re-check your working step by step.';
...
$string['model'] = 'Model';
$string['model_desc'] = 'Model id for the chosen provider, for example gpt-4o-mini, gemini-2.5-flash, or claude-3-5-haiku. Free options include any OpenRouter model id ending in :free, or gemini-2.5-flash on Google\'s free tier. Avoid "thinking" or reasoning models (for example Qwen3): they tend to output their reasoning and can reveal the answer instead of giving a hint.';
